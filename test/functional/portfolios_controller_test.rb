...
class PortfoliosControllerTest < ActionController::TestCase
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post :create, portfolio: { description: @portfolio.description, name: @portfolio.name, thumbnail: @portfolio.thumbnail }
    end
  ...
  test "should update portfolio" do
    put :update, id: @portfolio, portfolio: { description: @portfolio.description, name: @portfolio.name, thumbnail: @portfolio.thumbnail }
    assert_redirected_to portfolio_path(assigns(:portfolio))
  end
