			...
			<section class="portfolio-item">
				...
				<div class="slider-wrapper theme-default">
		       		<div id="slider" class="nivoSlider">
		       			<img src="<?php echo url('assets/images/work/fom-01.png') ?>" alt="" />
		       			<img src="<?php echo url('assets/images/work/fom-02.png') ?>" alt="" />
		       			<img src="<?php echo url('assets/images/work/fom-03.png') ?>" alt="" />
		        	</div>
		    	</div>
